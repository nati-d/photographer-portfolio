	...
	return (
		<section className='max-w-7xl w-full mx-auto flex flex-col md:flex-row items-center md:justify-between px-4 md:px-8 py-6 gap-4 md:gap-0 relative overflow-hidden '>
			...
			<div className='flex flex-col gap-1 z-10 items-center md:items-start text-center md:text-left w-full md:w-auto'>
				...
				<span
					className='text-2xl md:text-4xl font-bold text-foreground/80'
					style={{fontFamily: "var(--font-heading)"}}
				>
					Zadig Shiferaw
				</span>
			...
			<div className='flex flex-col items-center md:items-end z-10 w-full md:w-auto'>
				<span
					className='text-base md:text-xl font-medium text-foreground/90 flex flex-col md:flex-row items-center md:items-end gap-2 md:gap-0'
					style={{fontFamily: "var(--font-heading)"}}
				>
					LET'S
					<Link
						href='/contact'
						className='inline-flex items-center ml-0 md:ml-2 mt-2 md:mt-0 px-4 py-1.5 rounded-full bg-accent text-accent-foreground font-semibold text-base shadow hover:bg-accent/80 transition-colors'
					>
						<ArrowUpRight size={18} />
					</Link>
				</span>
				<span
					className='text-base md:text-xl font-medium text-foreground/90 -mt-1 text-center md:text-right'
					style={{fontFamily: "var(--font-heading)"}}
				>
					WORK TOGETHER
				</span>
